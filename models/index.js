...
Party.belongsToMany(Food, { through: 'PartyDecoration', foreignKey: 'party_id' });
Decoration.belongsToMany(Party, { through: 'PartyDecoration', foreginKey: 'decoration_id' });

Party.belongsToMany(Food, { through: 'PartyActivities', foreignKey: 'party_id' });
Activities.belongsToMany(Party, { through: 'PartyActivities', foreginKey: 'activities_id' });

Party.belongsToMany(Food, { through: 'PartyDrink', foreignKey: 'party_id' });
Drink.belongsToMany(Party, { through: 'PartyDrink', foreginKey: 'drink_id' });

Party.belongsToMany(Food, { through: 'PartyMusic', foreignKey: 'party_id' });
